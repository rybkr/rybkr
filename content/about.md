...
I'm a software engineer focused on systems programming and education. I build tools that make complex ideas tangible—whether that's a [convolution visualizer](/projects/convolution/) that turns signal processing into something you can see and manipulate, or a [C++ curriculum](/library/writing/) that treats fundamentals with the rigor they deserve.
...
I've given [talks](/library/talks-publications/) at conferences, written [technical guides](/library/writing/) covering C++ from basics to templates and memory safety, and built [open-source tools](/projects/) ranging from chess engines to embedded games.
...
- **Email**: [rbaker@xtier.com](mailto:rbaker@xtier.com)
- **GitHub**: [github.com/rybkr](https://github.com/rybkr)
- **LinkedIn**: [linkedin.com/in/rybkr](https://linkedin.com/in/rybkr)
